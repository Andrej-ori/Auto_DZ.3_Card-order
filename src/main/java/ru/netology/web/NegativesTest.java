...
//        driver.findElement(By.cssSelector("[data-test-id=agreement]")).click(); //не нажимаем чакбокс
    ...
    @Test
    //забыли заполнить поля Имя и Телефон, не нажат чек бокс с соглашением, должно подсвечиваться только первое неправильно заполненое поле
